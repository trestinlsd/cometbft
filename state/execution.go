...
func (blockExec *BlockExecutor) ApplyBlock(
	...
	blockExec.logger.Info("executed block(ApplyBlock)", "height", block.Height, "app_hash", abciResponse.AppHash)
...
func ExecCommitBlock(
	...
	logger.Info("executed block(ExecCommitBlock)", "height", block.Height, "app_hash", resp.AppHash)
